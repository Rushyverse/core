...
public interface IHttpEntitySupplier {
    ...
    public companion object {
         ...
         */
        public fun rest(configuration: SupplierConfiguration): IHttpEntitySupplier =
         ...
         */
        public fun cache(configuration: SupplierConfiguration): HttpCacheEntitySupplier =
         ...
         */
        public fun cachingRest(configuration: SupplierConfiguration): HttpStoreEntitySupplier =
         ...
         */
        public fun cacheWithRestFallback(configuration: SupplierConfiguration): IHttpEntitySupplier =
         ...
         */
        public fun cacheWithCachingRestFallback(configuration: SupplierConfiguration): IHttpEntitySupplier =
